...
sinfo_cmd="/cm/shared/apps/slurm/current/bin/sinfo -a --Node -o '%.10N %8O %c %.10mMB %.10eMB %.5a %.6t %12E %G'|uniq|grep alloc|grep -v -e a100|awk '{if (($2/$3)<0.3||($2/$3)>1.1) print $1,int($2/$3*100), $3, $7}'|sort -n -k2"
